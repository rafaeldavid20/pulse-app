...
export const MobileTabBar: React.FC = () => {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-base/95 backdrop-blur-xl border-t border-subtle px-2 py-1.5 flex items-center justify-around select-none">
        {tabs.map((tab) => {
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1 px-3 py-1.5 rounded-xl text-secondary hover:text-primary transition-all min-w-[56px] text-[10px] font-medium"
        >
